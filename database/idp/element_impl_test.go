...
func TestElementImpl(t *testing.T) {
	testElement(t, newElement(test_id, test_names, test_authUri, test_tokUri, test_acntUri, test_coopFrUri, test_coopToUri, test_keys))
}
...
func TestElementImplKeyDownload(t *testing.T) {
	...
	elem := newElement(test_id, test_names, test_authUri, test_tokUri, test_acntUri, test_coopFrUri, test_coopToUri, nil)
	elem.keyUri = keyUri
